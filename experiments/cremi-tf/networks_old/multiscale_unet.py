...
# should also work
def multiscale_loss(gt_affs, output, loss_weights):
    assert len(gt_affs) == len(output) == len(loss_weights) == 4
    loss = tf.losses.mean_squared_error(gt_affs[0], gt_affs[0], loss_weights[0]) +\
        tf.losses.mean_squared_error(gt_affs[1], gt_affs[1], loss_weights[1]) +\
        tf.losses.mean_squared_error(gt_affs[2], gt_affs[2], loss_weights[2]) +\
        tf.losses.mean_squared_error(gt_affs[3], gt_affs[3], loss_weights[3])
    return loss
