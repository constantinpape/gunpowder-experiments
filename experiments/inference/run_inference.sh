...
PRED_PATH=$(readlink -f $HOME/Work/my_projects/nnets/gunpowder-experiments/experiments/inference/)
...
nvidia-docker run --rm \
    ...
    /bin/bash -c "PYTHONPATH=${GUNPOWDER_PATH}:\$PYTHONPATH; python -u ${PRED_PATH}/large_scale_inference.py $1 $2 $3"
