...
# TODO !!!
AFF_PATH=$(readlink -f $HOME/Work/my_projects/nnets/affinities/)
...
nvidia-docker run --rm \
    ...
    /bin/bash -c "export CUDA_VISIBLE_DEVICES=$2 PYTHONPATH=${GUNPOWDER_PATH}:${BACKEND_PATH}:${AFF_PATH}:\$PYTHONPATH; python -u ${WORKDIR}/cremi_ms_affs.py $1 $3"
